  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-8 pt-8 pb-4">
        <div>
          <h2 className="text-lg font-bold text-white tracking-tight">Leave Approvals</h2>
          <p className="text-[11px] font-medium text-white/30 uppercase tracking-widest mt-0.5">Pending Requests</p>
        </div>
        ...
        {leaves.length === 0 ? (
          ...
          <div className="space-y-4">
            {leaves.map((leave, i) => (
              <div
                key={leave.id}
                className="flex items-center gap-4 p-4 rounded-2xl bg-white/[0.03] border border-white/5 group/item hover:bg-white/[0.06] transition-all duration-300"
              >
                {/* User Info */}
                <div className="relative shrink-0">
                  {leave.image ? (
                    ...
                    <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-[11px] font-bold">
                      {leave.avatar}
                    </div>
                  )}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-white truncate">{leave.name}</p>
                  <div className="flex items-center gap-2 mt-0.5">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[#f3350c]">
                      {leave.type}
                    </span>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 rounded-xl bg-[#22c55e]/10 text-[#22c55e] hover:bg-[#22c55e] hover:text-white transition-all disabled:opacity-50"
                  >
