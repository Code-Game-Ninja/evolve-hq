...
import type { Task, TaskPriority, TaskProject, TaskStatus } from "./task-data";
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="in-progress">
                        {statusColors["in-progress"].label}
                      </option>
                  ...
                  <div>
                    ...
                    <select
                      value={project}
                      onChange={(e) =>
                        setProject(e.target.value as TaskProject)
                      }
                      style={selectStyle}
                      onFocus={handleFocus}
                      onBlur={handleBlur}
