// Task Board View — Kanban columns with drag-and-drop + reorder
"use client";
...
export function TaskBoardView({
  ...
  // Group tasks by column (preserves array order)
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    if (activeCol === overCol) {
      ...
      // Rebuild full task array preserving order
      const newTasks: Task[] = [];
      ...
      // Safety net for tasks not in any column
